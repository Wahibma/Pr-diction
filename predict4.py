...
with col1:
    ...
    st.write("""
    ### Impact des Modèles
    - **Régression Linéaire** : Fournit une interprétation simple mais peut manquer de précision pour les relations complexes.
    - **Forêt Aléatoire** : Bon équilibre entre interprétabilité et précision, gère bien les relations non linéaires.
    - **Gradient Boosting** : Très précis pour les relations complexes, mais peut être plus difficile à interpréter.
    """)
